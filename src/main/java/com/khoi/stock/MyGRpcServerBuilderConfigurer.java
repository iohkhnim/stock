...
public class MyGRpcServerBuilderConfigurer extends GRpcServerBuilderConfigurer {
  ...
  private final String certChainFilePath = "src/main/java/com/khoi/stock/key/serverstock.crt";
  private final String privateKeyFilePath = "src/main/java/com/khoi/stock/key/serverstock.pem";
